...
from utils.unet.diffusers.attention import BasicTransformerBlock
    ...
    def forward(
        ...
        **kwargs,
        ...
        for block in self.transformer_blocks:
            # utils/nets/diffusers/attention.py BasicTransformerBlock/forward
            hidden_states, loss = block(
                hidden_states,
